  ...
  implements Serializable, Cloneable
{
  ...
  public static class Point implements Serializable, Cloneable {
    ...
    /*@Pure*/ public boolean equals (double x, double y, double z) {
  ...
  /*@SideEffectFree*/ public LinearTernaryCoreFloat clone() {
    try {
 ...
 double maxsep_triples (/*@Nullable*/ Point[] pa) {
  ...
  public double[] calc_tri_linear(/*@Nullable*/ Point[] points) { // TODO: remove annotation after refactoring method
    ...
    if (wrapper != null) {
      wrapper.log("Preliminary: %s %s GCD: %s", i_var, j_var, MathMDE.gcd(i_var, j_var));
      wrapper.log("Preliminary: %s %s GCD: %s", k_var, Stand_const, MathMDE.gcd(k_var, Stand_const));
