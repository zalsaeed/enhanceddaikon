...
/**
 * Represents double scalars that are non-zero.  Prints as <code>x != 0</code>.
 */
  ...
  extends SingleFloat
{
  ...
  /*@SideEffectFree*/ public String format_using(/*>>> @Prototype NonZeroFloat this,*/ OutputFormat format) {
