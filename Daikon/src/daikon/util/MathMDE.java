...
public final class MathMDE {
  ...
  /** Return z such that (z == x mod y) and (0 &le; z &lt; abs(y)).
  ...
  /**
   * Return an array containing all the numbers <b>not</b> in its argument array
   ...
   * @param nums numbers to be excluded
